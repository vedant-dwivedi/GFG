<h2><a href="https://www.geeksforgeeks.org/problems/java-strings-set-15112/1?page=1&category=Java&sortBy=submissions">Java Strings | Set 1</a></h2><h3>Difficulty Level : School</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given two strings S1 and S2 as input. Your task is to concatenate two strings and then reverse the string. Finally print the reversed string.</span><br>
<br>
